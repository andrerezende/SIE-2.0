...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Selecao', true), array('action' => 'edit', $selecao['Selecao']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Selecao', true), array('action' => 'delete', $selecao['Selecao']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $selecao['Selecao']['id'])); ?> </li>
