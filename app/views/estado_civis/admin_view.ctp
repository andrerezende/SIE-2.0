...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Estado Civil', true), array('action' => 'edit', $estadoCivil['EstadoCivil']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Estado Civil', true), array('action' => 'delete', $estadoCivil['EstadoCivil']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $estadoCivil['EstadoCivil']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($estadoCivil['Candidato'] as $candidato):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
