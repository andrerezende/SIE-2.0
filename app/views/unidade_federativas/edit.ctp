...
<?php echo $this->Form->create('UnidadeFederativa');?>
	<fieldset>
		<legend><?php __('Edit Unidade Federativa'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('UnidadeFederativa.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('UnidadeFederativa.id'))); ?></li>
