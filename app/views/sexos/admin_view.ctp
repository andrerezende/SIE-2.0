...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sexo', true), array('action' => 'edit', $sexo['Sexo']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Sexo', true), array('action' => 'delete', $sexo['Sexo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $sexo['Sexo']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($sexo['Candidato'] as $candidato):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
