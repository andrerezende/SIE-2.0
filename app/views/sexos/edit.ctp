...
<?php echo $this->Form->create('Sexo');?>
	<fieldset>
		<legend><?php __('Edit Sexo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Sexo.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Sexo.id'))); ?></li>
